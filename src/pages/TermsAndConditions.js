...
const TermsAndConditions = () => {
    return (
        <div className='m-20'>
            <h2 className='text-5xl font-bold mb-16'>Terms And Conditions</h2>

            <div className='text-xl text-justify'>
                <p className='mb-8'>Welcome to AP Solutions, an online inventory management system owned and operated by AP Solutions Solution.</p>
                ...
                <p>
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>B) PREFERENTIAL PRICING OR DISCOUNTS:</span>
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>C) GENERAL OBLIGATIONS</span>
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>D) ACCESS CONDITIONS:</span>
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>E) REASONABLE USE POLICY</span>
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>F) COMMUNICATION CONDITIONS</span>
                    <br />
                    ...
                    <br />
                    <br />
                    <span className='text-xl font-semibold'>G) INDEMNITY</span>
                    <br />
