        ...
        <section className='p-4 mt-16'>
            ...
            <label htmlFor="create-new-product" className="modal cursor-pointer">
                <label className="modal-box lg:w-7/12 md:w-10/12 w-11/12 max-w-4xl relative" htmlFor="">
                    ...
                    <ModalHeading modalHeading={'Create a Main Stock Request'} />
            ...
            <label htmlFor="update-pharmacy-product" className="modal cursor-pointer">
                <label className="modal-box lg:w-7/12 md:w-10/12 w-11/12 max-w-4xl relative" htmlFor="">
                    ...
                    <ModalHeading modalHeading={'Update a Product'} />
                    ...
                    <form>
                        <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-1 mb-2'>
                            ...
                            <Input title={'Category'} type='text' placeholder='Category name' name='category' />
                            <Input title={'Company'} type='text' placeholder='Company name' name='company' />
                        </div>
                        ...
                        <div className="flex flex-col w-full lg:flex-row mt-4 place-content-center">
                            <div className="grid">
                                ...
                                <div className='grid grid-cols-2 gap-x-4'>
                                    <Input title={'Purchase Unit Type'} type='text' placeholder='Unit type' name='purchaseUnitType' />
                            ...
                            <div className="grid">
                                ...
                                <div className='grid grid-cols-2 gap-x-4'>
                                    <Input title={'Sales Unit Type'} type='text' placeholder='Unit type' name='salesUnitType' />
                                ...
                                tableRowsData={
                                    [
                                        ...
                                        <span className='flex items-center gap-x-1'>
                                            <EditButton />
                                            <DeleteButton
                                                deleteApiLink='/requestedItems/main/'
                                                itemId={product._id}
