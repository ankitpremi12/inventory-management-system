...
const PrivacyPolicy = () => {
    return (
        <div className='m-20'>
            <h2 className='text-5xl font-bold mb-16'>Privacy Policy</h2>

            <div className='text-xl text-justify'>
                <p className='mb-8'>The latest revision of this Privacy Policy was published on May 23, 2018.
                    <br />
                    Please check back regularly to keep track of any Privacy Policy updates. The previous version of this Policy can be viewed here. At DEAR Systems we care about your privacy and believe in transparency. That’s why we are committed to being upfront about our privacy practices. We only collect personal information necessary to deliver our services and we handle it carefully and sensibly.</p>

                <h3 className='text-3xl font-semibold my-10'>A. Who we are?</h3>

                <p>This Policy explains our privacy practices for dearsystems.com (we’ll refer to it as the “website”, “Website”) and our other services provided by DEAR Systems (“DEAR Systems” together with “we,” “us,” and “our”). We’ll refer to the Website and our other services as the “Services.” This Privacy Policy describes why and how we collect and use the personal information of our customers and website visitors. It also describes your options to choose how we use your personal data and how to contact us with any concerns and requests to in relation to that.
                ...
                <h3 className='text-3xl font-semibold my-10 '>B. Data Collection</h3>

                <p>DEAR Systems processes your personal data so you can better use our services. Below you can find an overview of the personal data that we process, if you give permission for this, and for which services this happens.</p>

                <p>
                    <br />
                    <span className='text-xl font-semibold'>B.1 Statistics</span>
                    <br />
